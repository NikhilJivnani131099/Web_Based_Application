package com.nimpat.hr.servlets;
import javax.servlet.*;
import javax.servlet.http.*;
import java.io.*;
import com.nimpat.hr.dl.*;
import java.util.*;
import java.text.*;
import java.math.*;
...
pw.println("<img src='/styleone/images/logo1.png' style='float:left;height: 40px;width: 40px;'><div style='margin-top:9px;margin-bottom:9px;font-size: 20pt;'>NIMPAT Pvt. Ltd.</div>");
pw.println("</div>");
...
pw.println("&copy; NIMPAT Pvt. Ltd. 2021");
pw.println("</div>");
...
// the following code has been picked up from update Designation.
pw.println("<!DOCTYPE html>");
pw.println("<html lang='en'>");
pw.println("<head>");
pw.println("<title>HR Application</title>");
...
pw.println("<!-- Header starts here -->");
pw.println("<div style='margin: 5px;width: 90hw;height: auto;border: 1px solid black;'>");
pw.println("<a href='/styleone/index.html'><img src='/styleone/images/logo1.png' style='float:left;height: 40px;width: 40px;'></a><div style='margin-top:9px;margin-bottom:9px;font-size: 20pt;'>NIMPAT Pvt. Ltd.</div>");
pw.println("</div>");
pw.println("<!-- Header ends here -->");
pw.println("<!-- content-section starts here -->");
pw.println("<div style='width:90hw;height:70vh;margin:5px;border:1px solid white'>");
...
pw.println("</table>");
pw.println("</div>");
pw.println("<div style='height:19vh;margin-left:5px;margin-right:5px;margin-bottom:5px;margin-top:5px;padding:5px;border: 1px solid black;'>");
